...
namespace OutOfOffice_web.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
            ViewData["ProjectManagerId"] = new SelectList(_context.Employees, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProjectType,StartDate,EndDate,ProjectManagerId,Comment,Status")] Project project)
        {
            ...
            ViewData["ProjectManagerId"] = new SelectList(_context.Employees, "Id", "Id", project.ProjectManagerId);
            return View(project);
        }
